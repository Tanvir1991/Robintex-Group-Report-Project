...
{
    public partial class EmPimPackinginvoiceMaster
    {
        ...
        public int? EpimStatus { get; set; }
        public int? EpimIsedited { get; set; }
        public int? EpimIsdeleted { get; set; }
        public DateTime? EmPimBuyersubmissiondate { get; set; }
        public string EpimInvoiceunit { get; set; }
        public DateTime? EpimExfactorydate { get; set; }
        public long? EpimQuantity { get; set; }
        public string EpimFcrnumber { get; set; }
        public DateTime? EpimFcrdate { get; set; }
        public string EpimShippingBillNo { get; set; }
        public DateTime? EpimShippingBillDate { get; set; }
    }
}
