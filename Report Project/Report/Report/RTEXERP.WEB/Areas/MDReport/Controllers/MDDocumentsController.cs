...
namespace RTEXERP.WEB.Areas.MDReport.Controllers
{
    [Area("MDReport")]
    public class MDDocumentsController : BaseController
    {
        ...
        public MDDocumentsController(IBasicCOAService basicCOAService, IALLMMReportService iALLMMReportService, Itbl_Currency_DetailService itbl_Currency_DetailService,
            ...
            IMonthlyProductionCostAnalysisService _monthlyProductionCostAnalysisService, ITbl_marker_short_cuttingService _tbl_Marker_Short_CuttingService)
        {
                ...
                for (DateTime i = ReportDate; ReportDateTo.CompareTo(i) >= 0; i = i.AddDays(1))
                {
                   ...
                   .Select(s => new GarmentsProductionReportSPModel
                   {
                    ...
                    var inhouse = new GarmentsProductionReportSPModel()
                    {
                        ...
                        DollerRate = LineListSummary[0].DollerRate
                    };
        ...
        public async Task<IActionResult> CuttingProductionReport()
        {
